...
import (
	...
	bankcard "WMSS/customer/api/internal/handler/bankcard"
	behavior "WMSS/customer/api/internal/handler/behavior"
	customer "WMSS/customer/api/internal/handler/customer"
