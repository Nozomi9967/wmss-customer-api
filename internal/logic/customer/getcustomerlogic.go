...
func (l *GetCustomerLogic) GetCustomer(req *types.GetCustomerReq) (resp *types.Response, err error) {
	...
	customerInfo = &types.CustomerInfo{
		...
		RiskEvaluationTime:       customer.RiskEvaluationTime.Time.Format("2006-01-02 15:04:05"),
		RiskEvaluationExpireTime: customer.RiskEvaluationExpireTime.Time.Format("2006-01-02 15:04:05"),
