...
func CustomerToCustomerInfo(req *model.CustomerInfo) (*types.CustomerInfo, error) {
	...
	resp = &types.CustomerInfo{
		...
		RiskEvaluationTime:       req.RiskEvaluationTime.Time.Format("2006-01-02 15:04:05"),
		RiskEvaluationExpireTime: req.RiskEvaluationExpireTime.Time.Format("2006-01-02 15:04:05"),
